...
left_join lost some genes, change to full_join
```{r}
...
df<- full_join(tcx_a, bm22_a, by=c("Name", "Class"), suffix = c(".TCX", ".bm22")) %>%
    full_join(bm36_a, by=c("Name", "Class")) %>%
    full_join(dpc_a, by=c("Name", "Class"), suffix = c(".bm36", ".DLPFC")) %>%
    full_join(bm10_a, by=c("Name", "Class")) %>%
    full_join(bm44_a, by=c("Name", "Class"), suffix = c(".bm10", ".bm44")) %>%
    full_join(cbe_a, by=c("Name", "Class")) 
```
