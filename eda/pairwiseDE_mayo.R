...
# design2 <- model.matrix(~0+Diagnosis, data = rna[[region]]$pdata)
# colnames(design2) <- c("Con", "PA", "PSP", "AD")
# myContr <- makeContrasts(
#     PA.CON = PA-Con,
#     PSP.CON = PSP-Con,
#     AD.CON = AD-Con,
#     PSP.PA = PSP-PA,
...
#     levels = design2
# )
# qlfAnova2 <- glmQLFTest(fit, contrast = myContr)
# resAnova2 <- topTags(qlfAnova2, n = Inf, sort.by = "none")
